<img src="JunkGraveyardCover.png" alt="Junk Graveyard: Low fidelity cover art made in Blender, with alt text especially for screen readers">
...
2. Download / clone this repository
   a. Use `--depth=1` to clone, there are large files in commit history
